...
import { FaCalendar, FaVideo, FaFileAlt, FaClock, FaStethoscope, FaTimes, FaCommentDots, FaPlus, FaCheckCircle, FaExclamationCircle, FaHourglassHalf, FaMapMarkerAlt, FaEnvelope, FaPhone, FaLink, FaPaperPlane, FaTimesCircle, FaCalendarCheck, FaInfoCircle, FaClipboardList } from "react-icons/fa";
        ...
        if (existingApt) {
          ...
          detailsHtml = `
            <div style="
              ...
              text-align: left;
            ">
              <h4 style="margin: 0 0 1rem 0; color: #92400e; font-size: 1.1rem; display: flex; align-items: center; gap: 0.5rem;">
